...
var NativeHls = {
	...
	load: function load(settings) {
		if (typeof Hls !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : '/static/module/mediaelement-4.2.6/build/hls.min.js';
...
var HlsNativeRenderer = {
	...
	options: {
		prefix: 'native_hls',
		hls: {
			path: '/static/module/mediaelement-4.2.6/build/hls.min.js',
